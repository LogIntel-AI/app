        ...
        <div class="relative z-10 flex flex-col min-h-screen">
            ...
            <nav class="w-full px-6 py-4 flex justify-between items-center glass-card bg-white/70 dark:bg-gray-900/70 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold tracking-tight">InterLog-AI</span>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            <a href="{{ route('login') }}" class="font-medium text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition">Log in</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition shadow-lg shadow-blue-500/30">Get Started</a>
                            @endif
                        @endauth
                    @endif
                </div>
            ...
            <main class="flex-grow flex flex-col items-center justify-center px-6 py-20 text-center animate-slide-up">
                ...
                <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 max-w-4xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('register') }}" class="px-8 py-4 text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition shadow-xl shadow-blue-500/40 transform hover:-translate-y-1">Start for free</a>
                    <a href="#how-it-works" class="px-8 py-4 text-lg font-bold text-gray-800 bg-white hover:bg-gray-50 border border-gray-200 dark:text-white dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-700 rounded-xl transition transform hover:-translate-y-1">See how it works</a>
                </div>
            </main>
            ...
            <section id="how-it-works" class="py-24 bg-white/50 dark:bg-gray-900/50 glass-card">
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl" id="carousel-container">
                        <div class="carousel-inner flex w-full" id="carousel">
                            <!-- Slide 1 -->
                            <div class="w-full flex-shrink-0 flex flex-col md:flex-row items-center p-8 md:p-16 gap-8">
                                <div class="flex-1">
                                    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center text-xl font-bold mb-6">1</div>
                                    <h3 class="text-2xl font-bold mb-4">Generate Your API Key</h3>
                                    <p class="text-gray-600 dark:text-gray-400 text-lg">Create an account and register your server in our dashboard. You'll instantly receive a unique, secure API Key. This key allows your server to securely push logs directly to our ingestion engine.</p>
                                </div>
                                <div class="flex-1 bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
                                    <pre class="text-sm text-gray-800 dark:text-gray-300 font-mono overflow-x-auto"><code>Server Token: 
...
POST https://your-domain.com/api/logs/ingest</code></pre>
                            ...
                            <div class="w-full flex-shrink-0 flex flex-col md:flex-row items-center p-8 md:p-16 gap-8">
                                <div class="flex-1">
                                    <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-400 rounded-full flex items-center justify-center text-xl font-bold mb-6">2</div>
                                    <h3 class="text-2xl font-bold mb-4">Send Your Logs</h3>
                                    <p class="text-gray-600 dark:text-gray-400 text-lg">Use a simple cron job, curl script, or your application's logging library (like Monolog) to forward your error logs to our endpoint with the API token attached.</p>
                                </div>
                                <div class="flex-1 bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
                                    <pre class="text-sm text-green-600 dark:text-green-400 font-mono overflow-x-auto"><code>{
  "level": "error",
  ...
  "timestamp": "2026-05-03 10:42:11"
                            ...
                            <div class="w-full flex-shrink-0 flex flex-col md:flex-row items-center p-8 md:p-16 gap-8">
                                <div class="flex-1">
                                    <div class="w-12 h-12 bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-400 rounded-full flex items-center justify-center text-xl font-bold mb-6">3</div>
                                    <h3 class="text-2xl font-bold mb-4">AI Diagnosis & Alerts</h3>
                                    <p class="text-gray-600 dark:text-gray-400 text-lg">Our background OpenAI engine instantly analyzes the error, categorizes it, explains exactly what went wrong, and suggests a fix on your dashboard.</p>
                                </div>
                                <div class="flex-1 bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
                                    <pre class="text-sm text-purple-600 dark:text-purple-400 font-mono overflow-x-auto"><code>Analysis:
